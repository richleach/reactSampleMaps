      ...
      >
        ...
        <Marker 
          ...
          className={highlightedId === house.id ? "marker-active" : ""}> 
            <button style={{width: "30px", height: "30px", fontSize: "30px"}} type="button" onClick={() => setSelected(house)}>

              <img src={highlightedId === house.id ? "home-color.svg" : "home-solid.svg"} alt="House here!" className="w-8" />
            ...
            <Popup 
              ...
              closeOnClick={false}>
                  <div className="text-center">
                    ...
                    <Link href={`/houses/${selected.id}`}><a>View House</a></Link>
